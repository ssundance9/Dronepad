...
public class AppService extends Service {
    ...
    private DronePadApp dpApp;

    @Override
    public void onCreate() {
        super.onCreate();

        dpApp = (DronePadApp) getApplication();
    ...
    private void bringUpCellularNetwork(Context context) {
        ...
        connMgr.requestNetwork(networkReq, new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(Network network) {
                ...
                DronePadApp.setCellularNetworkAvailability(true);
            }
        });
    }*/
    ...
    private void bringDownCellularNetwork() {
        ...
        DronePadApp.setCellularNetworkAvailability(false);
    }*/
